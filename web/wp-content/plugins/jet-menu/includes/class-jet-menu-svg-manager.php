...
if ( ! class_exists( 'Jet_Menu_SVG_Manager' ) ) {

	/**
	 * Define Jet_Menu_SVG_Manager class
	 */
	class Jet_Menu_SVG_Manager {
		...
		public function init() {
			...
			$svg_enabled = jet_menu_option_page()->get_option( 'svg-uploads', 'enabled' );
 ...
 * @return object
 */
function jet_menu_svg_manager() {
	return Jet_Menu_SVG_Manager::get_instance();
}
