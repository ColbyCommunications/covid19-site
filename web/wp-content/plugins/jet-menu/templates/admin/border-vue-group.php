<cx-vui-switcher
	...
	description="<?php
		echo sprintf( esc_html__( 'Read more %1$s', 'jet-menu' ),
			htmlspecialchars( "<a href='https://developer.mozilla.org/en-US/docs/Web/CSS/border' target='_blank'>border</a>", ENT_QUOTES )
		);
	?>"
...
>
	<cx-vui-select
		...
		description="<?php
			echo sprintf( esc_html__( 'Read more %1$s', 'jet-menu' ),
				htmlspecialchars( "<a href='https://developer.mozilla.org/en-US/docs/Web/CSS/border-style' target='_blank'>border style</a>", ENT_QUOTES )
			);
		?>"
		:wrapper-css="[ 'equalwidth' ]"
		size="fullwidth"
	...
	<cx-vui-dimensions
		...
		description="<?php
			echo sprintf( esc_html__( 'Read more %1$s', 'jet-menu' ),
				htmlspecialchars( "<a href='https://developer.mozilla.org/en-US/docs/Web/CSS/border-width' target='_blank'>border width</a>", ENT_QUOTES )
			);
		?>"
		:wrapper-css="[ 'equalwidth' ]"
